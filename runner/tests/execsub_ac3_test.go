...
func Test_ExecSubm_AC_Python(t *testing.T) {
	...
	tr.TestAgentExecSpec.RunArgs = []string{"python", "/workspace/submissions/test001/main.py"}

	tr.CreateTempLocations(t)
	tr.CopyFiles(t, "../examples/main.py")
