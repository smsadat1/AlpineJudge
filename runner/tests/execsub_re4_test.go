...
func Test_ExecSubm_RE_ThreadSpam(t *testing.T) {
	...
	tr.TestAgentExecSpec.CompileArgs[5] = fmt.Sprintf("/workspace/submissions/%v/threadbomb.cpp", tr.TestJobSpec.SubmissionID)
	tr.CreateTempLocations(t)
	tr.CopyFiles(t, "../examples/threadbomb.cpp")
