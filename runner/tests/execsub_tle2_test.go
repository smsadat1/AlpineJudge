...
func Test_ExecSubm_TLE_buysloop(t *testing.T) {
	...
	tr.TestAgentExecSpec.CompileArgs[5] = fmt.Sprintf("/workspace/submissions/%v/busyloop.cpp", tr.TestJobSpec.SubmissionID)
	tr.CreateTempLocations(t)
	tr.CopyFiles(t, "../examples/busyloop.cpp")
